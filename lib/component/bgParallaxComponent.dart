...
class Bgparallaxcomponent extends ParallaxComponent with HasGameRef {
  ...
  FutureOr<void> onLoad() async {
    parallax = await game.loadParallax(_parallelImage,
      baseVelocity: Vector2(0, -10), //nilai x untuk mengatur pergerakan bg, nilai negatif menjadi bergerak ke kiri. nilai y membuat bg bergerak, nilai negatif membuat bergerak ke bawah
      velocityMultiplierDelta: Vector2(1, 1), //mengatur kecepatan bg bergerak
